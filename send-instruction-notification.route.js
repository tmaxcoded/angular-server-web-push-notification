...
exports.sendInstructionNotification = void 0;
...
function sendInstructionNotification(req, res) {
    ...
    //   })
    Promise.all(in_memory_db_1.USER_SUBSCRIPTIONS
...
exports.sendInstructionNotification = sendInstructionNotification;
